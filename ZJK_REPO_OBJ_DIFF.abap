...
TYPES:
  ...
  BEGIN OF ygs_object,
    ...
    parent_object   TYPE tadir-object,
    parent_obj_name TYPE tadir-obj_name,
  END OF ygs_object,
...
CLASS gcl_obj_checker DEFINITION ABSTRACT.
  ...
  PROTECTED SECTION.
    DATA:
      as_logger     TYPE REF TO gcl_logger,
...
CLASS gcl_logger IMPLEMENTATION.
  ...
  METHOD show_log.
    ...
    CALL FUNCTION 'REUSE_ALV_GRID_DISPLAY'
      EXPORTING
        i_callback_program = 'ZJK_REPO_OBJ_DIFF'
        is_layout          = ls_layout
...
CLASS gcl_generic_code_checker IMPLEMENTATION.
  ...
  METHOD evaluate_delta.
    ...
    IF sy-subrc = 0.
      ...
      as_logger->add_warning( 'Difference in "ABAP code"' ).
    ELSE.
...
CLASS gcl_cpub_checker IMPLEMENTATION.
  ...
  METHOD evaluate_delta.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Events"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Exceptions"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Implementation-based instance relationship"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Methods"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Meta relationship"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Parameters"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Redefined methods"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Types"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Type group application"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Aliases"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Attributes"' ).
    ELSE.
      ov_status = aco_status_equal.
    ENDIF.
  ENDMETHOD.                    "evaluate_delta
...
CLASS gcl_clsd_checker IMPLEMENTATION.
  ...
  METHOD evaluate_delta.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Friend relationship"' ).
      RETURN.
    ENDIF.
...
CLASS gcl_intf_checker IMPLEMENTATION.
  ...
  METHOD evaluate_delta.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Interface composition"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Interface"' ).
      RETURN.
    ENDIF.
...
CLASS gcl_func_checker IMPLEMENTATION.
  ...
  METHOD evaluate_delta.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Additional Attributes"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Function Module Interface"' ).
    ELSE.
      ov_status = aco_status_equal.
    ENDIF.
...
CLASS gcl_tabd_checker IMPLEMENTATION.
  ...
  METHOD evaluate_delta.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "General attributes"' ).
      RETURN.
    ENDIF.
    "Fields Attributes
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Fields"' ).
    ELSE.
      ov_status = aco_status_equal.
    ENDIF.
...
CLASS gcl_rept_checker IMPLEMENTATION.
  ...
  METHOD evaluate_delta.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Text pool"' ).
    ELSE.
      ov_status = aco_status_equal.
    ENDIF.
  ENDMETHOD.                    "evaluate_delta
...
CLASS gcl_dynp_checker IMPLEMENTATION.
  ...
  METHOD evaluate_delta.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Screen Short Description"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Screen fields"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Screen Key Word Texts"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Screen flow logic"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Screen Parameters"' ).
    ELSE.
      ov_status = aco_status_equal.
    ENDIF.
...
CLASS gcl_cuad_checker IMPLEMENTATION.
  ...
  METHOD evaluate_delta.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Menu bars"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Menu bars (4.0 onwards)"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Internal administration data"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Function Key Settings"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Fixed Functions on Application Toolbars"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Pushbuttons"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Pushbuttons (4.0 onwards)"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Context menu"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Technical texts"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Attributes (4.0 onwards)"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Dynamic function texts"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Functions with icons"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Function text"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Function Texts Language-Independent (from 7.0)"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Include menus"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Administration info"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Dynamic menu texts"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Menus"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Menu structure (4.0 onwards)"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Menu texts"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Language-Independent Menu Table (7.0 onwards)"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Function key assignment"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Function key assignments (4.0 onwards)"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Active functions"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Status functions (4.0 onwards)"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Status list"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Status (4.0 onwards)"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Status texts"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Standard toolbar"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Texts"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "GUI Title"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Title codes (4.0)"' ).
    ELSE.
      ov_status = aco_status_equal.
    ENDIF.
...
CLASS gcl_domd_checker IMPLEMENTATION.
  ...
  METHOD evaluate_delta.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Fixed values and domain texts"' ).
    ELSE.
      ov_status = aco_status_equal.
    ENDIF.
  ENDMETHOD.                    "evaluate_delta
...
CLASS gcl_vied_checker IMPLEMENTATION.
  ...
  METHOD evaluate_delta.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Base Tables"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Selection Conditions"' ).
    ELSE.
      ov_status = aco_status_equal.
    ENDIF.
  ENDMETHOD.                    "evaluate_delta
...
CLASS gcl_ttyd_checker IMPLEMENTATION.
  ...
  METHOD evaluate_delta.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Interface structure for table types"' ).
      RETURN.
    ENDIF.
    ...
    IF sy-subrc = 0.
      ov_status = aco_status_changed.
      as_logger->add_warning( 'Difference in "Interface structure for table type key fields"' ).
    ELSE.
      ov_status = aco_status_equal.
    ENDIF.
  ENDMETHOD.                    "evaluate_delta
...
"$. Endregion CLASSES IMPLEMENTATIONS
